...
export function renderSignaturePage() {
    ...
    if (colorSheme === "dark") {
        ...
        <table style="font-family: Arial, sans-serif; font-size: 14px; color: #333; line-height: 1.2;">
            ...
            <tr>
                <td style="padding: 0; vertical-align: middle; width: 20px;">
                    <img src="https://www.michael.markov.uk/src/icons/light/phone.svg" alt="phone" width="20" height="20" style="vertical-align: middle;">
                </td>
            ...
            <tr>
                <td style="padding: 0; vertical-align: middle; width: 20px;">
                    <img src="https://www.michael.markov.uk/src/icons/light/mail.svg" alt="mail" width="18" height="18" style="vertical-align: middle;">
                </td>
                <td style="padding: 2px 0; vertical-align: middle;">
            ...
            <tr>
                <td style="padding: 0; vertical-align: middle; width: 20px;">
                    <img src="https://www.michael.markov.uk/src/icons/light/location.svg" alt="location" width="20" height="20" style="vertical-align: middle;">
                </td>
                <td style="padding: 2px 0; vertical-align: middle; color: #000000; font-size: 12px;">Steinkamp 10i, 28717 Bremen, Germany</td>
            </tr>
            <tr>
                <td style="padding: 0; vertical-align: middle; width: 20px;">
                    <img src="https://www.michael.markov.uk/src/icons/light/globe.svg" alt="mail" width="18" height="18" style="vertical-align: middle;">
                </td>
                <td style="padding: 2px 0; vertical-align: middle;">
        ...
        <table style="font-family: Arial, sans-serif; font-size: 14px; color: #333; line-height: 1.2;">
            ...
            <tr>
                <td style="padding: 0; vertical-align: middle; width: 20px;">
                    <img src="https://www.michael.markov.uk/src/icons/dark/phone.svg" alt="phone" width="20" height="20" style="vertical-align: middle;">
                </td>
                <td style="padding: 2px 0; vertical-align: middle;">
                    <a href="tel:+49 1515 6526597" style="text-decoration: none; color: #0078d4; font-size: 12px;">+49 1515 6526597</a>
                </td>
            ...
            <tr>
                <td style="padding: 0; vertical-align: middle; width: 20px;">
                    <img src="https://www.michael.markov.uk/src/icons/dark/mail.svg" alt="mail" width="18" height="18" style="vertical-align: middle;">
                </td>
                <td style="padding: 2px 0; vertical-align: middle;">
                    <a href="mailto:michael@markov.uk" style="text-decoration: none; color: #0078d4; font-size: 12px;">michael@markov.uk</a>
                </td>
            ...
            <tr>
                <td style="padding: 0; vertical-align: middle; width: 20px;">
                    <img src="https://www.michael.markov.uk/src/icons/dark/location.svg" alt="location" width="20" height="20" style="vertical-align: middle;">
                </td>
                <td style="padding: 2px 0; vertical-align: middle; color: #000000; font-size: 12px;">Steinkamp 10i, 28717 Bremen, Germany</td>
            </tr>
            <tr>
                <td style="padding: 0; vertical-align: middle; width: 20px;">
                    <img src="https://www.michael.markov.uk/src/icons/dark/globe.svg" alt="mail" width="18" height="18" style="vertical-align: middle;">
                </td>
                <td style="padding: 2px 0; vertical-align: middle;">
                    <a href="https://www.michael.markov.uk" style="text-decoration: none; color: #0078d4; font-size: 12px;">www.michael.markov.uk</a>
                </td>
